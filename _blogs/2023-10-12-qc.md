---
layout: post
title: "Hướng dẫn QML #2: Project"
categories: quantum
---

Ở phần này, mình sẽ đi sâu vào Quantum machine learning (QML) một xíu, chúng ta sẽ làm quen với model khá phổ biến: CNN và phiên bản nâng cấp Quantum CNN/ Quanvolutional NN.
